...
function Work() {
    return (
        <div id='works' className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            <a href="https://github.com/kodjozecodeur/README" className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500'>show more <Image src={assets.right_arrow_bold} alt='show icon' className='w-4' />  </a>
        </div>
    )
}
